  ...
  return (
    <section className={styles.root} aria-label="Cadastros operacionais">
      ...
      {employeeEditor && <EmployeeDrawer employee={employeeEditor === "new" ? null : employeeEditor} companies={companies} catalogs={catalogs} busy={busy} editing={employeeEditing} activeTab={employeeDetailTab}
        history={history} historyLoading={historyLoading} canManage={canManageRegistrations} canConsultTangerino={canConsultTangerino} canManageExams={canManageExams} onTab={(next) => { if (next === "history" && employeeEditor !== "new") void openHistory(employeeEditor); else setEmployeeDetailTab(next); }}
...
function EmployeeDrawer({
  ...
  canManage, canConsultTangerino, canManageExams, onTab, onCompanyCatalogs, onEdit, onClose,
