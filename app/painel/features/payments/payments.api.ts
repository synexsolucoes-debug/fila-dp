...
export function normalizeInvoiceRow(row: Row): InvoiceRow {
  return {
    ...
    uploadedVia: text(pick(row, "uploadedVia", "uploaded_via")) || "panel",
...
export function normalizeInvoiceDetail(payload: Row): InvoiceDetail {
  ...
  return {
    invoice: {
      ...
      uploadedVia: text(pick(invoice, "uploadedVia", "uploaded_via")) || "panel",
      uploadedByName: text(pick(invoice, "uploadedByName", "uploaded_by_name")),
