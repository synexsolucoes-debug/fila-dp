export type ProcessLifecycleStatus = "draft" | "in_review" | "published" | "inactive" | "archived";
export type ProcessVersionStatus = "draft" | "in_review" | "published" | "retired";
export type ProcessSection = "library" | "modeler" | "mine" | "drafts" | "review" | "published" | "archived" | "history" | "settings";
export type ProcessPermissions = { view: boolean; manage: boolean; publish: boolean };
export type ProcessArea = { id: string; name: string; code: string; status: string; managerUserId: string };
export type ProcessMember = { id: string; name: string; email: string; role: string };
export type ProcessCompanyOption = { id: string; name: string; status: string };
...
export type ProcessOptions = { currentUserId:string; areas:ProcessArea[]; members:ProcessMember[]; companies:ProcessCompanyOption[] };
export type ProcessCatalogPayload = { processes:ProcessDefinition[]; versions:ProcessVersionSummary[]; currentUserId:string; permissions:ProcessPermissions };
