...
export const capabilityCatalog: Record<Capability, CapabilityDescription> = {
  ...
  "invoice.read": { area: "payments", label: "Ver as notas fiscais da competência e os documentos anexados" },
  "invoice.create": { area: "payments", label: "Registrar uma nota fiscal no pagamento do prestador" },
  "invoice.upload": { area: "payments", label: "Anexar o arquivo da nota fiscal" },
  "invoice.update": { area: "payments", label: "Corrigir os dados informados da nota e a política de conferência" },
  "invoice.review": { area: "payments", label: "Colocar notas em conferência e definir o responsável" },
  "invoice.approve": { area: "payments", label: "Aprovar a nota fiscal, liberando o pagamento do prestador" },
  ...
  "ledger.manage": { area: "operations", label: "Criar e editar lançamentos e suas parcelas" },
  "ledger.approve": { area: "operations", label: "Aprovar ou recusar um lançamento" },
  "ledger.pay": { area: "operations", label: "Registrar o pagamento do adiantamento ao colaborador" },
  "ledger.confirm": { area: "operations", label: "Confirmar o desconto efetivamente realizado na competência" },
  "ledger.reverse": { area: "operations", label: "Estornar um desconto confirmado, com justificativa" },
  "ledger.override": { area: "operations", label: "Autorizar desconto acima do saldo devido, com justificativa" },
  "ledger.reschedule": { area: "operations", label: "Reprogramar, pausar ou antecipar parcelas" },
  "ledger.import": { area: "operations", label: "Importar a planilha de vales e descontos" },
  "ledger.export": { area: "operations", label: "Exportar a competência para lançamento na folha" },
  "ledger.close": { area: "operations", label: "Encerrar a conferência da competência" },
  "ledger.reopen": { area: "operations", label: "Reabrir a conferência já encerrada, com justificativa" },
